...
### Kendala & Sedikit Kisah Saya

&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Mungkin kendala saya adalah karena belum pernah memegang linux ataupun sistem operasi dan program terkait, sehingga saya telat memulai start. Namun, alhamdulillah setelah membaca-baca dan mencari-cari pembahasan, berbekal google, youtube, dan bantuan AI (hehe) saya bisa mulai mengerjakan soal 3 ini. Soal yang paling sulit bagi saya adalah nomor 2 (On the Run) dan 4 (Money). Saya kemarin bener-bener susah untuk mencari contoh base code untuk script bash membuat progres bar, entah karena saya mainnya kurang jauh dalam ekplor search google atau karena saya kurang tepat dalam mengeetik search key nya, tetapi akhirnya dapet basenya (bar progres biasa), kemudian saya tinggal menambahi cara membuat progresnya berjalan dengan durasi random, pada akhirnya saya meminta bantuan Copilot untuk menunjukkan caranya, dan akhirnya bisa dengan menggunakan awk. Lalu untuk nomor 4 sendiri saya tidak terbayang bagaimana cara membuat efek matrix di terminal saya :), alhamdulillahnya saya mendapat referensi dari satu web (tertera di bawah). Setelah mencoba memahami kodenya, saya juga meminta bantuan AI untuk merapikan codenya, akhirnya jadi output seperti code asli, hanya saja punya saya dapat menampilkan karakter"/simbol" sesuai yang diminta pada soal. Overall alhamdulillah saya bisa menyelesaikannya, walau tidak dengan usaha saya sendiri, tentunya dibantu dengan AI, saya harap kedepannya saya bisa memahami lebih lanjut, sehingga bisa memaksimalkan pengerjaan dengan bantuan google search atau youtube, mungkin lebih meminimalisir penggunaan AI biar saya tidak kebergantungan juga kedepannya.
